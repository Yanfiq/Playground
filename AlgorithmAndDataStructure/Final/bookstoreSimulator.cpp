...
public:
    ...
    static void parseXML(){
        ...
        std::cout << "Node foobar has value " << root_node->value() << "\n";
        for (auto *attr = root_node->first_attribute();
            attr; 
    ...
    std::list<std::string> search(std::string keyword){
        ...
        // Iterate over the book data
            ...
            {
                std::cout << Book_metadata->value() << std::endl;
...
rapidxml::xml_document<> XMLDataHandler::doc;
rapidxml::xml_node<>* XMLDataHandler::root_node;
